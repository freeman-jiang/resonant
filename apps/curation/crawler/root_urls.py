...
ROOT_URLS = [
    ...
    {
        "url": "https://radreads.co/antifragile-career/",
        "title": "How to design an antifragile career",
    },
    ...
    {'url': 'https://luttig.substack.com/p/dont-forget-microsoft',
    ...
    {'url': 'https://blog.helftone.com/clear-in-the-icloud/',
        'title': 'Clear in the iCloud'},
    {'url': 'https://astralcodexten.substack.com/p/every-bay-area-house-party',
